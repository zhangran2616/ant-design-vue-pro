  ...
  data () {
    ...
    return {
      ...
      ipPoolValidator: (rule, value, callback) => {
        const reg = /^(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)-(\d{1,2}|1\d{1,2}|2[0-4]\d|25[0-5])$/
        if (!reg.test(value)) {
      ...
      dnsValidator: (rule, value, callback) => {
        const reg = /^(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)$/
        if (!reg.test(value)) {
